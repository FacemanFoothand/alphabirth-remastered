...
local pseudobulbar_affect = Item("Pseudobulbar Affect") ---@type Item
pseudobulbar_affect.desc = include("ab_src.integrations.eid").pseudobulbar_affect

---@param player EntityPlayer
pseudobulbar_affect:AddCallback(ModCallbacks.MC_POST_PEFFECT_UPDATE, function(player)
